...
impl MyActionGroup {
    ...
    async fn stateful_toggle(&self, state: bool) -> Option<bool> {
        self.log
            .borrow_mut()
    ...
    #[action(stateful)]
    async fn stateful_toggle_default(&self, state: bool) -> Option<bool> {
        self.log
            .borrow_mut()
    ...
    async fn stateful_text(&self, state: String) -> Option<String> {
        self.log
            .borrow_mut()
    ...
    async fn stateful_toggle_with_parameter(&self, state: bool, mut param: String) -> Option<bool> {
        if state {
    ...
    async fn change_state_with_inferred_parameter(&self, state: bool) -> Option<bool> {
        self.log
            .borrow_mut()
    ...
    async fn change_state_without_parameter(&self, state: bool) -> Option<bool> {
        self.log
            .borrow_mut()
